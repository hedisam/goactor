...
type SendRequest struct {
	...
	//
	//	*SendRequest_UserMessage
	//	*SendRequest_SystemMessage
	//	*SendRequest_InternalMessage
...
func (x *SendRequest) GetRecipientRef() string {
	if x != nil {
...
func (m *SendRequest) GetMessage() isSendRequest_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *SendRequest) GetUserMessage() *UserMessage {
	if x, ok := x.GetMessage().(*SendRequest_UserMessage); ok {
		return x.UserMessage
	}
	return nil
}

func (x *SendRequest) GetSystemMessage() *SystemMessage {
	if x, ok := x.GetMessage().(*SendRequest_SystemMessage); ok {
		return x.SystemMessage
	}
	return nil
}

func (x *SendRequest) GetInternalMessage() *InternalMessage {
	if x, ok := x.GetMessage().(*SendRequest_InternalMessage); ok {
...
type SendRequest_UserMessage struct {
	UserMessage *UserMessage `protobuf:"bytes,10,opt,name=user_message,json=userMessage,proto3,oneof"`
}

type SendRequest_SystemMessage struct {
	SystemMessage *SystemMessage `protobuf:"bytes,11,opt,name=system_message,json=systemMessage,proto3,oneof"`
}

type SendRequest_InternalMessage struct {
	InternalMessage *InternalMessage `protobuf:"bytes,12,opt,name=internal_message,json=internalMessage,proto3,oneof"`
}

func (*SendRequest_UserMessage) isSendRequest_Message() {}

func (*SendRequest_SystemMessage) isSendRequest_Message() {}

func (*SendRequest_InternalMessage) isSendRequest_Message() {}
...
var file_clustering_v1_clustering_service_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_clustering_v1_clustering_service_proto_goTypes = []any{
	...
	(*UserMessage)(nil),     // 4: clustering.v1.UserMessage
	(*SystemMessage)(nil),   // 5: clustering.v1.SystemMessage
	(*InternalMessage)(nil), // 6: clustering.v1.InternalMessage
}
var file_clustering_v1_clustering_service_proto_depIdxs = []int32{
	4, // 0: clustering.v1.SendRequest.user_message:type_name -> clustering.v1.UserMessage
	5, // 1: clustering.v1.SendRequest.system_message:type_name -> clustering.v1.SystemMessage
	6, // 2: clustering.v1.SendRequest.internal_message:type_name -> clustering.v1.InternalMessage
	0, // 3: clustering.v1.NodeService.Spawn:input_type -> clustering.v1.SpawnRequest
	2, // 4: clustering.v1.NodeService.Send:input_type -> clustering.v1.SendRequest
	1, // 5: clustering.v1.NodeService.Spawn:output_type -> clustering.v1.SpawnResponse
	3, // 6: clustering.v1.NodeService.Send:output_type -> clustering.v1.SendResponse
...
func file_clustering_v1_clustering_service_proto_init() {
	...
	file_clustering_v1_clustering_service_proto_msgTypes[2].OneofWrappers = []any{
		(*SendRequest_UserMessage)(nil),
		(*SendRequest_SystemMessage)(nil),
		(*SendRequest_InternalMessage)(nil),
	}
	type x struct{}
